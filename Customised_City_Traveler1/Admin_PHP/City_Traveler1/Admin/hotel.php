...
<br>
  ...
  <h2 class="w3-container"><b>HOTEL DETAILS</b></h2>
  <div class="container">
<div class="row">   
...

{
    ...
    <form method="post" enctype="multipart/form-data">
       ...
       <tr>
    <td> <a href="show_hotel1.php?id=<?php echo $r['hid'];?>">
      <?php echo $r["hname"];?></td></a>
    
   
      <Td>
      <a href="delete_hotel.php?id=<?php echo $r['hid'];?>">
    ...
    <Td>
      <a href="edit_hotel.php?id=<?php echo $r['hid'];?>">
...
<br><br>
 <center><button class="btn btn-primary" onclick="window.location.href='add_hotel.php'"><b>ADD</b></button></center>
