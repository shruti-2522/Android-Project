...
if(isset($_POST["btnsave"]))
{
  ...
  mysqli_query($con,"update tblhotel set hname='$txthotel',stime='$txtstime',etime='$txtetime',addr='$txtaddr' where hid=".$_GET["id"]);

  echo "<script>window.location.href='hotel.php';</script>";
    exit;
}
  $q1=mysqli_query($con,"select * from tblhotel where hid=".$_GET["id"]);
...
<div id="page-wrapper">
  ...
  <div class="row">
    ...
    <h3><center><b>EDIT HOTEL<b></center></h3>
    </div>
    ...
    <table class="table">
       ...
       <td><b>Enter Hotel Name:</b></prtd>
            <td>
              <div class="col-sm-6">
                <input type="text"  name="txthotel" class="form-control"  value='<?php echo $r1['hname'];?>'>
              </div>
            </td>
          </tr>
          </tr>
