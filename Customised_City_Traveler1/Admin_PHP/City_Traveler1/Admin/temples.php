...
<br>
  ...
  <h2 class="w3-container"><b>TEMPLES DETAILS</b></h2>
    <div class="container">
<div class="row">   
...
<table class="w3-table" align="center" id="myTable">
 ...
 <?php
  ...
  $q1=mysqli_query($con,"select * from tbltemp"); 
...

{
    ...
    <form method="post" enctype="multipart/form-data">
       ...
       <tr>
    <td> <a href="show_temple1.php?id=<?php echo $r['tid'];?>">
      <?php echo $r["temp_name"];?></td></a>
    
   
      <Td>
      <a href="delete_temple.php?id=<?php echo $r['tid'];?>">
    ...
    <Td>
      <a href="edit_temple.php?id=<?php echo $r['tid'];?>">
     ...
     <br><br>
      ...
      <center><button class="btn btn-primary" onclick="window.location.href='add_temples.php'"><b>ADD</b></button></center>
</body>
</html>
