...
<br>
  ...
  <h2 class="w3-container"><b>RESTAURENT DETAILS</b></h2>
    <div class="container">
<div class="row">   
...
<table class="w3-table" align="center" id="myTable">
  <th><b>Restaurent Name</b></th>
  <th><b>Delete<b></th>
  <th><b>Edit</b></th>
 <?php


  $q1=mysqli_query($con,"select * from tblrest"); 
...

{
    ...
    <form method="post" enctype="multipart/form-data">
       ...
       <tr>
    <td> <a href="show_rest1.php?id=<?php echo $r['rid'];?>">
      <?php echo $r["rname"];?></td></a>
    
   
      <Td>
      <a href="delete_rest.php?id=<?php echo $r['rid'];?>">
    ...
    <Td>
      <a href="edit_rest.php?id=<?php echo $r['rid'];?>">
     ...
     <br><br>
      ...
      <center><button class="btn btn-primary" onclick="window.location.href='add_rest.php'"><b>ADD</b></button></center>
</body>
</html>
