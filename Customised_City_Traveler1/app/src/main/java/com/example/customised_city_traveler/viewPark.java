...
public class viewPark extends AppCompatActivity {
    ...
    public void show() {
        ...
        s1.abc();
        s1.api.selectparkdetails(""+getIntent().getExtras().get("id"),
                ...
                new Callback<Response>() {
                    ...
                    public void success(Response result, Response response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArr.length(); i++) {
                                ...
                                t1.setText(jsonObj.getString("pname").toString());
                    ...
                    public void failure(RetrofitError error) {
                        Toast.makeText(viewPark.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
