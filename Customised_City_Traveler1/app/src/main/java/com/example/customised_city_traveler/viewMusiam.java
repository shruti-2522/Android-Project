...
public class viewMusiam extends AppCompatActivity {
    mylib l1=new mylib();
    Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_musiam);
    ...
    public void show() {
        ...
        s1.abc();
        s1.api.selectmusiamdetails(""+getIntent().getExtras().get("id"),
                ...
                new Callback<Response>() {
                    ...
                    public void success(Response result, Response response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArr.length(); i++) {
                                ...
                                t1.setText(jsonObj.getString("mname").toString());
                    ...
                    public void failure(RetrofitError error) {
                        Toast.makeText(viewMusiam.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
