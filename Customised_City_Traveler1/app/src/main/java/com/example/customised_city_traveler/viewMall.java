...
public class viewMall extends AppCompatActivity {
    mylib l1=new mylib();
    Spinner spinner;
    ...
    public void show() {
        ...
        s1.abc();
        s1.api.selectmalldetails(""+getIntent().getExtras().get("id"),
                ...
                new Callback<Response>() {
                    ...
                    public void failure(RetrofitError error) {
                        Toast.makeText(viewMall.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
